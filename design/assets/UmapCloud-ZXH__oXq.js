import{V as C,B as it,a as $,S as ft,b as ct,c as Pe,P as lt,G as Ft,F as et,D as Po,R as Eo,g as To,N as Le,f as Ro,h as io,i as Io,M as co,j as Do}from"./three-BH243BCb.js";import{D as pt,E as Qt,a as Fe,I as Lo,u as V,s as Fo,U as _e}from"./index-Dj01syjS.js";const Jt=new Set,Ce=new Map,te=new Set,ze={register(t){return te.add(t),()=>{te.delete(t)}},hasRig(t){return te.has(t)},emit(t){Ce.set(t.rig,t.time),Jt.forEach(e=>e(t))},subscribe(t){return Jt.add(t),()=>{Jt.delete(t)}},lastEvent(t){return Ce.get(t)??-1/0}},_t=`
